...
describe TechniquesController do
  ...
  def mock_technique(stubs={})
    @mock_technique ||= mock_model(Technique, stubs).as_null_object
  end

  describe "GET index" do
    it "assigns all techniques as @techniques" do
      Technique.stub(:all) { [mock_technique] }
      get :index
      assigns(:techniques).should eq([mock_technique])
    end
  end

  describe "GET show" do
    it "assigns the requested technique as @technique" do
      Technique.stub(:find).with("37") { mock_technique }
      get :show, :id => "37"
      assigns(:technique).should be(mock_technique)
    end
  end

  describe "GET new" do
    it "assigns a new technique as @technique" do
      Technique.stub(:new) { mock_technique }
      get :new
      assigns(:technique).should be(mock_technique)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created technique as @technique" do
        Technique.stub(:new).with({'these' => 'params'}) { mock_technique(:save => true) }
        post :create, :technique => {'these' => 'params'}
        assigns(:technique).should be(mock_technique)
      end

      it "redirects to the created technique" do
        Technique.stub(:new) { mock_technique(:save => true) }
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved technique as @technique" do
        Technique.stub(:new).with({'these' => 'params'}) { mock_technique(:save => false) }
        post :create, :technique => {'these' => 'params'}
        assigns(:technique).should be(mock_technique)
      end

      it "re-renders the 'new' template" do
        Technique.stub(:new) { mock_technique(:save => false) }
        post :create, :technique => {}
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested technique" do
        Technique.should_receive(:find).with("37") { mock_technique }
        mock_technique.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => "37", :technique => {'these' => 'params'}
      end

      it "assigns the requested technique as @technique" do
        Technique.stub(:find) { mock_technique(:update_attributes => true) }
        put :update, :id => "1"
        assigns(:technique).should be(mock_technique)
      end
    ...
    describe "with invalid params" do
      it "assigns the technique as @technique" do
        Technique.stub(:find) { mock_technique(:update_attributes => false) }
        put :update, :id => "1"
        assigns(:technique).should be(mock_technique)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the techniques list" do
      Technique.stub(:find) { mock_technique }
      delete :destroy, :id => "1"
